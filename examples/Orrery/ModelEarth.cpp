...
ModelEarth::ModelEarth(VmaAllocator vmaAllocator, VBBDevice* pDevice, VBBCanvas* pCanv) : ModelBase(vmaAllocator, pDevice, pCanv) {}
...
bool ModelEarth::initModel(void) {
    // **************************************************
    // Create the pipeline
    ...
    VBBMakeSphere(sphere, 0.4f, 52, 26);
...
bool ModelEarth::drawModel(VkCommandBuffer cmdBuffer, glm::mat4 proj, glm::mat4 modelView) {
